...
*/
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("qrious", e) : t.QRious = e()
}(this, function() {
    "use strict";
    function t(t) {
    ...
    var n = function(t) {
        ...
        _ = Math.random(),
        d = function(t) {
            return "Symbol(".concat(void 0 === t ? "" : t, ")_", (++l + _).toString(36))
        },
        v = h("keys"),
        p = d,
        y = function(t) {
        ...
        w = Object.getPrototypeOf || function(t) {
            return t = k(t), g(t, b) ? t[b] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? m : null
        },
        B = e(function(t) {
            var e = t.exports = {
                version: "2.4.0"
        ...
        U = function(t, e) {
            ...
            var n,
                r;
            if (e && "function" == typeof (n = t.toString) && !z(r = n.call(t)))
                return r;
            if ("function" == typeof (n = t.valueOf) && !z(r = n.call(t)))
                return r;
            if (!e && "function" == typeof (n = t.toString) && !z(r = n.call(t)))
                return r;
        ...
        K = N ? Object.defineProperty : function(t, e, n) {
            if (D(t), e = R(e, !0), D(n), I)
                try {
                    return q(t, e, n)
                } catch (t) {}
        ...
        tt = function(t, e, n) {
            ...
            u && (n = e);
            for (r in n)
                i = !o && d && void 0 !== d[r], i && r in l || (s = i ? d[r] : n[r], l[r] = u && "function" != typeof d[r] ? n[r] : c && i ? Y(s, H) : h && d[r] == s ? function(t) {
                    ...
                    return e[$] = t[$], e
                }(s) : f && "function" == typeof s ? Y(Function.call, s) : s, f && ((l.virtual || (l.virtual = {}))[r] = s, t & tt.R && _ && !_[r] && Z(_, r, s)))
        };
    ...
    var et = tt,
        ...
        st = function(t, e) {
            var n = (rt.Object || {})[t] || Object[t],
                r = {};
            r[t] = e(n), nt(nt.S + nt.F * it(function() {
                n(1)
            }), "Object", r)
        },
        ot = i,
    ...
    var at = B.Object.getPrototypeOf,
        ft = e(function(t) {
            t.exports = {
                default: at,
                __esModule: !0
        ...
        lt = t(ht),
        _t = et;
    _t(_t.S + _t.F * !N, "Object", {
        defineProperty: G.f
    });
    var dt = B.Object,
        vt = function(t, e, n) {
            return dt.defineProperty(t, e, n)
        },
        pt = e(function(t) {
            t.exports = {
                default: vt,
        ...
        bt = Math.floor,
        mt = function(t) {
            return isNaN(t = +t) ? 0 : (t > 0 ? bt : kt)(t)
        },
        wt = mt,
        Bt = n,
        Ot = function(t) {
            return function(e, n) {
                var r,
                    ...
                    o = wt(n),
                    u = s.length;
                return o < 0 || o >= u ? t ? "" : void 0 : (r = s.charCodeAt(o), r < 55296 || r > 56319 || o + 1 === u || (i = s.charCodeAt(o + 1)) < 56320 || i > 57343 ? t ? s.charAt(o) : r : t ? s.slice(o, o + 2) : (r - 55296 << 10) + (i - 56320) + 65536)
            }
        },
        Mt = !0,
        St = J,
        ...
        Lt = jt,
        Nt = Object("z").propertyIsEnumerable(0) ? Object : function(t) {
        ...
        xt = Math.min,
        zt = function(t) {
            return t > 0 ? xt(Ft(t), 9007199254740991) : 0
        },
        Ut = mt,
        Dt = Math.max,
        It = Math.min,
        Rt = function(t, e) {
            return t = Ut(t), t < 0 ? Dt(t + e, 0) : It(t, e)
        },
        qt = Ct,
        Kt = zt,
        Gt = Rt,
        ...
        Qt = function(t, e) {
            var n,
                ...
                s = [];
            for (n in r)
                n != Ht && Vt(r, n) && s.push(n);
            for (; e.length > i;)
                Vt(r, n = e[i++]) && (~Jt(s, n) || s.push(n));
            return s
        },
        ...
        ne = j,
        re = te,
        ie = N ? Object.defineProperties : function(t, e) {
            ne(t);
            for (var n, r = re(e), i = r.length, s = 0; i > s;)
                ee.f(t, n = r[s++], e[n]);
            return t
        },
        ...
        le = function() {
            var t,
                ...
                r = "<",
                i = ">";
            for (e.style.display = "none", se.appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write(r + "script" + i + "document.F=Object" + r + "/script" + i), t.close(), le = t.F; n--;)
                delete le[he][ae[n]];
            return le()
        },
        _e = Object.create || function(t, e) {
            var n;
            return null !== t ? (ce[he] = oe(t), n = new ce, ce[he] = null, n[fe] = t) : n = le(), void 0 === e ? n : ue(n, e)
        },
        de = e(function(t) {
            var e = h("wks"),
                n = d,
        ...
        ye = de("toStringTag"),
        ge = function(t, e, n) {
            t && !pe(t = n ? t : t.prototype, ye) && ve(t, ye, {
                configurable: !0,
                value: e
            })
        },
    ...
    var Be = function(t, e, n) {
        ...
        De = function(t, e, n, r, i, s, o) {
            ...
            if (g && (f = Pe(g.call(new t)), f !== Object.prototype && (Ne(f, h, !0), Oe || Ae(f, Te) || Ee(f, Te, Ue))), l && v && v.name !== ze && (_ = !0, p = function() {
                return v.call(this)
            }), Oe && !o || !Ce && !_ && d[Te] || Ee(d, Te, p), je[e] = p, je[h] = Ue, i)
                if (u = {
                    values: l ? p : c(ze),
                    keys: s ? p : c(xe),
                    entries: y
    ...
    var Re = function() {},
        ...
        We = Et,
        Ve = Ct;
    De(Array, "Array", function(t, e) {
        this._t = Ve(t), this._i = 0, this._k = e
    }, function() {
        var t = this._t,
            e = this._k,
            n = this._i++;
        return !t || n >= t.length ? (this._t = void 0, Ge(1)) : "keys" == e ? Ge(0, n) : "values" == e ? Ge(0, t[n]) : Ge(0, [n, t[n]])
    }, "values");
    We.Arguments = We.Array, Ke("keys"), Ke("values"), Ke("entries");
    for (var Xe = u, Je = J, He = Et, Qe = de("toStringTag"), Ye = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], Ze = 0; Ze < 5; Ze++) {
        var $e = Ye[Ze],
            tn = Xe[$e],
            en = tn && tn.prototype;
        en && !en[Qe] && Je(en, Qe, $e), He[$e] = He.Array
    }
    var nn = de,
        rn = {
            f: nn
        ...
        un = e(function(t) {
            var e = d("meta"),
                ...
                l = function(t) {
                    return a && _.NEED && u(t) && !r(t, e) && f(t), t
                },
                _ = t.exports = {
                    KEY: e,
                    NEED: !1,
        ...
        ln = G.f,
        _n = function(t) {
            var e = fn.Symbol || (fn.Symbol = cn ? {} : an.Symbol || {});
            "_" == t.charAt(0) || t in e || ln(e, t, {
                value: hn.f(t)
            })
        },
        dn = te,
        vn = Ct,
        pn = function(t, e) {
            for (var n, r = vn(t), i = dn(r), s = i.length, o = 0; s > o;)
                if (r[n = i[o++]] === e)
                    return n
        },
        ...
        On = function(t) {
            var e = mn(t),
                n = wn.f;
            if (n)
                for (var r, i = n(t), s = Bn.f, o = 0; i.length > o;)
        ...
        En = Qt,
        An = Yt.concat("length", "prototype"),
        jn = Object.getOwnPropertyNames || function(t) {
            return En(t, An)
        },
        Ln = {
            f: jn
        ...
        xn = function(t) {
            return Cn && "[object Window]" == Tn.call(t) ? Fn(t) : Pn(Nn(t))
        },
        zn = {
            f: xn
        },
        ...
        Wn = N ? Gn : function(t, e) {
            if (t = In(t), e = Rn(e, !0), Kn)
                try {
                    return Gn(t, e)
                } catch (t) {}
            if (qn(t, e))
                return Dn(!Un.f.call(t, e), t[e])
        },
        Vn = {
            f: Wn
        },
        ...
        Ar = tr("symbol-registry"),
        jr = tr("symbols"),
        Lr = tr("op-symbols"),
        Nr = Object[Or],
        Pr = "function" == typeof mr,
        Tr = Xn.QObject,
        Cr = !Tr || !Tr[Or] || !Tr[Or].findChild,
        Fr = Hn && $n(function() {
            return 7 != _r(kr({}, "a", {
                get: function() {
                    return kr(this, "a", {
            ...
            var r = gr(Nr, e);
            r && delete Nr[e], kr(t, e, n), r && t !== Nr && kr(Nr, e, r)
        } : kr,
        xr = function(t) {
            var e = jr[t] = _r(mr[Or]);
            return e._k = t, e
        },
        zr = Pr && "symbol" == typeof mr.iterator ? function(t) {
            return "symbol" == typeof t
        } : function(t) {
            return t instanceof mr
        },
        Ur = function(t, e, n) {
            return t === Nr && Ur(Lr, e, n), fr(t), e = hr(e, !0), fr(n), Jn(jr, e) ? (n.enumerable ? (Jn(t, Mr) && t[Mr][e] && (t[Mr][e] = !1), n = _r(n, {
                enumerable: lr(0, !1)
            })) : (Jn(t, Mr) || kr(t, Mr, lr(1, {})), t[Mr][e] = !0), Fr(t, e, n)) : kr(t, e, n)
        },
        Dr = function(t, e) {
            fr(t);
            for (var n, r = ur(e = cr(e)), i = 0, s = r.length; s > i;)
                Ur(t, n = r[i++], e[n]);
            return t
        },
        Ir = function(t, e) {
            return void 0 === e ? _r(t) : Dr(_r(t), e)
        },
        Rr = function(t) {
            var e = Er.call(this, t = hr(t, !0));
            return !(this === Nr && Jn(jr, t) && !Jn(Lr, t)) && (!(e || !Jn(this, t) || !Jn(jr, t) || Jn(this, Mr) && this[Mr][t]) || e)
        },
        qr = function(t, e) {
            if (t = cr(t), e = hr(e, !0), t !== Nr || !Jn(jr, e) || Jn(Lr, e)) {
                var n = gr(t, e);
                return !n || !Jn(jr, e) || Jn(t, Mr) && t[Mr][e] || (n.enumerable = !0), n
            }
        },
        Kr = function(t) {
            for (var e, n = br(cr(t)), r = [], i = 0; n.length > i;)
                Jn(jr, e = n[i++]) || e == Mr || e == Zn || r.push(e);
            return r
        },
        Gr = function(t) {
            for (var e, n = t === Nr, r = br(n ? Lr : cr(t)), i = [], s = 0; r.length > s;)
                !Jn(jr, e = r[s++]) || n && !Jn(Nr, e) || i.push(jr[e]);
            return i
        };
    Pr || (mr = function() {
        if (this instanceof mr)
            throw TypeError("Symbol is not a constructor!");
        var t = nr(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
                this === Nr && e.call(Lr, n), Jn(this, Mr) && Jn(this[Mr], t) && (this[Mr][t] = !1), Fr(this, t, lr(1, n))
            };
        return Hn && Cr && Fr(Nr, t, {
            configurable: !0,
            set: e
        }), xr(t)
    }, Yn(mr[Or], "toString", function() {
        return this._k
    }), vr.f = qr, pr.f = Ur, Ln.f = dr.f = Kr, bn.f = Rr, gn.f = Gr, Hn && !Mt && Yn(Nr, "propertyIsEnumerable", Rr, !0), ir.f = function(t) {
        return xr(rr(t))
    }), Qn(Qn.G + Qn.W + Qn.F * !Pr, {
        Symbol: mr
    });
    for (var Wr = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), Vr = 0; Wr.length > Vr;)
        rr(Wr[Vr++]);
    for (var Wr = yr(rr.store), Vr = 0; Wr.length > Vr;)
        sr(Wr[Vr++]);
    Qn(Qn.S + Qn.F * !Pr, "Symbol", {
        for: function(t) {
            return Jn(Ar, t += "") ? Ar[t] : Ar[t] = mr(t)
        },
        keyFor: function(t) {
            if (zr(t))
                return or(Ar, t);
        ...
        stringify: function(t) {
            if (void 0 !== t && !zr(t)) {
                for (var e, n, r = [t], i = 1; arguments.length > i;)
                    r.push(arguments[i++]);
                return e = r[1], "function" == typeof e && (n = e), !n && ar(e) || (e = function(t, e) {
                    if (n && (e = n.call(this, t, e)), !zr(e))
                        return e
                }), r[1] = e, Br.apply(wr, r)
            }
        }
    }), mr[Or][Sr] || J(mr[Or], Sr, mr[Or].valueOf), er(mr, "Symbol"), er(Math, "Math", !0), er(Xn.JSON, "JSON", !0), _n("asyncIterator"), _n("observable");
    var Xr = B.Symbol,
        Jr = e(function(t) {
            t.exports = {
                default: Xr,
        ...
        ei = {
            set: Object.setPrototypeOf || ("__proto__" in {} ? function(t, e, n) {
                try {
                    n = S(Function.call, Vn.f(Object.prototype, "__proto__").set, 2), n(t, []), e = !(t instanceof Array)
                } catch (t) {
                    e = !0
                }
                return function(t, r) {
        ...
        ni = et;
    ni(ni.S, "Object", {
        setPrototypeOf: ei.set
    });
    var ri = B.Object.setPrototypeOf,
        ii = e(function(t) {
            t.exports = {
                default: ri,
                __esModule: !0
    ...
    var oi = B.Object,
        ...
        ai = e(function(t) {
            ...
            e.default = function(t, e) {
                if ("function" != typeof e && null !== e)
                    throw new TypeError("Super expression must either be null or a function, not " + ("undefined" == typeof e ? "undefined" : (0, a.default)(e)));
        ...
        hi = function() {
            ...
            return gt(t, null, [{
                ...
                value: function(t, e, n, r, i) {
                    var s = t[e],
                        o = null != n ? n : r;
                    return "function" == typeof i && (o = i(o)), t[e] = o, o !== s
                }
            }, {
        ...
        _i = function(t) {
            function e() {
                return lt(this, e), Yr(this, (e.__proto__ || ct(e)).apply(this, arguments))
            }
            return ci(e, t), gt(e, [{
                key: "createCanvas",
                value: function() {
        ...
        mi = !bi || L(function() {
            ...
            return t[n] = 7, r.split("").forEach(function(t) {
                e[t] = t
            }), 7 != bi({}, t)[n] || Object.keys(bi({}, e)).join("") != r
        }) ? function(t, e) {
            for (var n = gi(t), r = arguments.length, i = 1, s = pi.f, o = yi.f; r > i;)
                for (var u, a = ki(arguments[i++]), f = s ? vi(a).concat(s(a)) : vi(a), c = f.length, h = 0; c > h;)
    ...
    var Bi = B.Object.assign,
            ...
            return gt(t, [{
                ...
                value: function(t) {
                    var e = this.qrious.padding || 0,
                        n = Math.floor((this.qrious.size - 2 * e) / t.width);
                    return Math.max(1, n)
                }
            }, {
                key: "getOffset",
                value: function(t) {
                    if (null != this.qrious.padding)
                        return this.qrious.padding;
                    var e = this.getModuleSize(t),
                        n = Math.floor((this.qrious.size - e * t.width) / 2);
                    return Math.max(0, n)
                }
            }, {
                key: "render",
        ...
        Ei = function(t) {
            ...
            return ci(e, t), gt(e, [{
                ...
                value: function(t) {
                    ...
                    i.fillStyle = e.foreground, i.globalAlpha = e.foregroundAlpha;
                    for (var s = 0; s < t.width; s++)
                ...
                value: function() {
                    var t = this.qrious,
                        e = t.canvas.getContext("2d");
                    e.lineWidth = 1, e.clearRect(0, 0, t.size, t.size), e.fillStyle = t.background, e.globalAlpha = t.backgroundAlpha, e.fillRect(0, 0, t.size, t.size)
                }
            }, {
                key: "resize",
                value: function() {
                    var t = this.qrious,
                        e = t.canvas;
                    e.width = t.size, e.height = t.size
                }
            }]), e
        }(Si),
        Ai = function() {
        ...
        Pi = function() {
            function t(e) {
                lt(this, t), this._badness = [], this._level = ji.LEVELS[e.level], this._polynomial = [], this._value = e.value, this._valueLength = this._value.length, this._version = 0, this._stringBuffer = [];
                for (var n = void 0, r = void 0, i = void 0, s = void 0; this._version < 40;) {
                    this._version++;
                    var o = 4 * (this._level - 1) + 16 * (this._version - 1);
                    if (i = ji.BLOCKS[o++], s = ji.BLOCKS[o++], n = ji.BLOCKS[o++], r = ji.BLOCKS[o], o = n * (i + s) + s - 3 + (this._version <= 9), this._valueLength <= o)
                        break
                }
            ...
            return gt(t, null, [{
                ...
                value: function(t, e) {
                    var n = void 0;
                    return t > e && (n = t, t = e, e = n), n = e, n += e * e, n >>= 1, n += t
                }
            }, {
                key: "_modN",
                value: function(t) {
                ...
                value: function(e, n, r, i) {
                    ...
                    for (var o = 0; o < n; o++) {
                        var u = Li.LOG[this._stringBuffer[e + o] ^ this._stringBuffer[r]];
                        if (255 !== u)
                            for (var a = 1; a < i; a++)
                ...
                value: function(t) {
                    ...
                    case 3:
                        for (var f = 0, c = 0; c < e; c++, f++) {
                            3 === f && (f = 0);
                            for (var h = f, l = 0; l < e; l++, h++)
                                3 === h && (h = 0), h || this._isMasked(l, c) || (this.buffer[l + c * e] ^= 1)
                        }
                        break;
                    case 4:
                        for (var _ = 0; _ < e; _++)
                            for (var d = 0, v = _ >> 1 & 1, p = 0; p < e; p++, d++)
                                3 === d && (d = 0, v = !v), v || this._isMasked(p, _) || (this.buffer[p + _ * e] ^= 1);
                        break;
                    case 5:
                        for (var y = 0, g = 0; g < e; g++, y++) {
                            3 === y && (y = 0);
                            for (var k = 0, b = 0; b < e; b++, k++)
                                3 === k && (k = 0), (b & g & 1) + !(!k | !y) || this._isMasked(b, g) || (this.buffer[b + g * e] ^= 1)
                        }
                        break;
                    case 6:
                        for (var m = 0, w = 0; w < e; w++, m++) {
                            3 === m && (m = 0);
                            for (var B = 0, O = 0; O < e; O++, B++)
                                3 === B && (B = 0), (O & w & 1) + (B && B === m) & 1 || this._isMasked(O, w) || (this.buffer[O + w * e] ^= 1)
                        }
                        break;
                    case 7:
                        for (var M = 0, S = 0; S < e; S++, M++) {
                            3 === M && (M = 0);
                            for (var E = 0, A = 0; A < e; A++, E++)
                                3 === E && (E = 0), (E && E === M) + (A + S & 1) & 1 || this._isMasked(A, S) || (this.buffer[A + S * e] ^= 1)
                        }
                    }
                }
            }, {
                ...
                value: function() {
                    ...
                    for (var e = 0; e < this._eccBlock; e++) {
                        this._polynomial[e + 1] = 1;
                        for (var n = e; n > 0; n--)
                ...
                value: function() {
                    ...
                    for (var s = 0, o = 0; o < n; o++) {
                        var u = 0;
                        this._badness[0] = 0;
                        for (var a = 0, f = 0; f < n; f++) {
                            var c = this.buffer[f + n * o];
                            a === c ? this._badness[u]++ : this._badness[++u] = 1, a = c, s += a ? 1 : -1
                        }
                    ...
                    for (var _ = 0; _ < n; _++) {
                        ...
                        for (var v = 0, p = 0; p < n; p++) {
                            var y = this.buffer[_ + n * p];
                            v === y ? this._badness[d]++ : this._badness[++d] = 1, v = y
                        }
                        e += this._getBadness(d)
                    }
                    return e
                }
            }, {
                ...
                value: function(t) {
                    ...
                    var n = this._calculateMaxLength();
                    t >= n - 2 && (t = n - 2, this._version > 9 && t--);
                    var r = t;
                    if (this._version > 9) {
                        for (this._stringBuffer[r + 2] = 0, this._stringBuffer[r + 3] = 0; r--;) {
                            var i = this._stringBuffer[r];
                            this._stringBuffer[r + 3] |= 255 & i << 4, this._stringBuffer[r + 2] = i >> 4
                        }
                        ...
                        for (this._stringBuffer[r + 1] = 0, this._stringBuffer[r + 2] = 0; r--;) {
                            var s = this._stringBuffer[r];
                            this._stringBuffer[r + 2] |= 255 & s << 4, this._stringBuffer[r + 1] = s >> 4
                        }
                ...
                value: function() {
                    ...
                    for (e = 0; e < 8; e++) {
                        this._applyMask(e);
                        var r = this._checkBadness();
                        if (r < n && (n = r, t = e), 7 === t)
                            break;
                        this.buffer = this._stringBuffer.slice(0)
                    }
                    for (t !== e && this._applyMask(t), n = ji.FINAL_FORMAT[t + (this._level - 1 << 3)], e = 0; e < 8; e++, n >>= 1)
                ...
                value: function() {
                    var t = this.width;
                    if (this._version > 1)
                        for (var e = Ai.BLOCK[this._version], n = t - 7;;) {
                ...
                value: function() {
                    for (var t = this.width, e = 0; e < 3; e++) {
                        var n = 0,
                            r = 0;
                        1 === e && (n = t - 7), 2 === e && (r = t - 7), this.buffer[r + 3 + t * (n + 3)] = 1;
                        for (var i = 0; i < 6; i++)
                            this.buffer[r + i + t * n] = 1, this.buffer[r + t * (n + i + 1)] = 1, this.buffer[r + 6 + t * (n + i)] = 1, this.buffer[r + i + 1 + t * (n + 6)] = 1;
                        for (var s = 1; s < 5; s++)
                            this._setMask(r + s, n + 1),
                            this._setMask(r + 1, n + s + 1), this._setMask(r + 5, n + s), this._setMask(r + s + 1, n + 5);
                        for (var o = 2; o < 4; o++)
                ...
                value: function() {
                    var t = this.width;
                    if (this._version > 6)
                        for (var e = Ni.BLOCK[this._version - 7], n = 17, r = 0; r < 6; r++)
                            for (var i = 0; i < 3; i++, n--)
                ...
                key: "_isMasked",
                value: function(e, n) {
                    var r = t._getMaskBit(e, n);
                    return 1 === this._mask[r]
                }
            }, {
                key: "_pack",
                value: function() {
                    for (var t = this.width - 1, e = this.width - 1, n = 1, r = 1, i = (this._dataBlock + this._eccBlock) * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2, s = 0; s < i; s++)
                        for (var o = this._stringBuffer[s], u = 0; u < 8; u++, o <<= 1) {
                            128 & o && (this.buffer[t + this.width * e] = 1);
                            do r ? t-- : (t++, n ? 0 !== e ? e-- : (t -= 2, n = !n, 6 === t && (t--, e = 9)) : e !== this.width - 1 ? e++ : (t -= 2, n = !n, 6 === t && (t--, e -= 8))), r = !r;
        ...
        Fi = function() {
            function t(e) {
                lt(this, t), e = t._parseOptions(e), hi.privatize(this, e);
                var n = this._element,
                    r = t._serviceManager.getService("element");
                this.canvas = n && r.isCanvas(n) ? n : r.createCanvas(), this.canvas.qrious = this, this.image = n && r.isImage(n) ? n : r.createImage(), this.image.qrious = this, this._renderers = [new Ei(this), new Ti(this)], this.update()
            }
            return gt(t, null, [{
                key: "use",
                value: function(e) {
                ...
                value: function() {
                    ...
                    this._renderers.forEach(function(e) {
                        return e.render(t)
                    })
                }
            }, {
                ...
                set: function(e) {
                    var n = hi.setter(this, "_background", e, t.DEFAULTS.background);
                    n && this.update()
                }
            }, {
                key: "backgroundAlpha",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_backgroundAlpha", e, t.DEFAULTS.backgroundAlpha);
                    n && this.update()
                }
            }, {
                key: "foreground",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_foreground", e, t.DEFAULTS.foreground);
                    n && this.update()
                }
            }, {
                key: "foregroundAlpha",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_foregroundAlpha", e, t.DEFAULTS.foregroundAlpha);
                    n && this.update()
                }
            }, {
                key: "level",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_level", e, t.DEFAULTS.level, hi.toUpperCase);
                    n && this.update()
                }
            }, {
                key: "mime",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_mime", e, t.DEFAULTS.mime);
                    n && this.update()
                }
            }, {
                key: "padding",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_padding", e, t.DEFAULTS.padding, hi.abs);
                    n && this.update()
                }
            }, {
                key: "size",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_size", e, t.DEFAULTS.size, hi.abs);
                    n && this.update()
                }
            }, {
                key: "value",
                ...
                set: function(e) {
                    var n = hi.setter(this, "_value", e, t.DEFAULTS.value);
                    n && this.update()
                }
            }]), t
        }();
    return Fi._serviceManager = new Ci, Fi.use(new di), Fi
});
